...
public class ExchangeUsdToPlnServiceTest {
    @Mock
    ...
    void shouldExchangeCurrencySuccessfully() {
        ...
        Customer customer = exchangeUsdToPlnService.exchangeUsdToPln(uuid);
    ...
    @Test
    void shouldThrowExceptionWhenBalanceUsdIs0() {
        UUID uuid = UUID.fromString("2ccefa01-4de6-444f-a315-886a74b343ea");
        ...
        IllegalArgumentException exception = assertThrows(
                ...
                () -> exchangeUsdToPlnService.exchangeUsdToPln(uuid)
        );

        assertEquals("Balance in USD must be greater than zero.", exception.getMessage());
    }
    ...
    private static final Customer CUSTOMER_UPDATED_1 = Customer.builder()
            ...
            .firstName("Imie")
            .lastName("Nazwisko")
            .balancePln(new BigDecimal("110.79"))
            .balanceUsd(BigDecimal.ZERO)
            .build();
